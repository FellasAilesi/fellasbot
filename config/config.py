...
API_ID = int(getenv("API_ID", "28480994"))

API_HASH = getenv("API_HASH", "eddbf24f0a04c848f80e9c697796ad55")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002155755638"))

# A name for your Music bot.

MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Fellas Muzik Bot")
